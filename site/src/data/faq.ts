  ...
  pl: [
    {
      id: "cena",
      q: "„Za drogo.”",
      a: "Sprint kosztuje mniej niż dwa miesięczne koszty etatu kontrolera, a eliminuje jego 3–4 dni pracy co miesiąc, więc zwraca się przed końcem kwartału. Dla porównania: moduł raportowy ERP to zwykle 6+ miesięcy i kwoty od 100 tys. zł. Nie sprzedajemy godzin, tylko zamknięty rezultat za stałą cenę.",
    },
    {
      id: "dane",
      q: "„Nasze dane są wrażliwe.”",
      a: "Dlatego nic nie wychodzi z firmy. Narzędzia działają lokalnie, na Waszych komputerach, na Waszych plikach. Po wdrożeniu nie mamy dostępu do danych. Hostowany panel KPI to opcja, a nawet on dostaje wyłącznie zagregowane wskaźniki, które sami zatwierdzicie.",
    },
    {
      id: "custom",
    ...
    },
    {
      id: "erp",
      q: "„Mamy już ERP.”",
      a: "Świetnie, nie zastępujemy ERP. Automatyzujemy pracę, która dzieje się PO eksporcie z niego: przeklejanie, sklejanie, raporty dla zarządu. Wchodzimy tam, gdzie ERP się kończy, a zaczyna Excel.",
    },
    {
      id: "kim",
  ...
  en: [
    {
      id: "cena",
      q: "“Too expensive.”",
      a: "A sprint costs less than two monthly salaries of a controller and removes 3–4 days of their work every month, so it pays for itself before the quarter ends. For comparison: an ERP reporting module usually means 6+ months and six-figure budgets. We don't sell hours; we sell a finished result at a fixed price.",
    },
    {
      id: "dane",
    ...
    },
    {
      ...
      a: "Great, we don't replace your ERP. We automate the work that happens AFTER the export: pasting, stitching, management reports. We step in where the ERP ends and Excel begins.",
    },
    {
      id: "kim",
      q: "“Who even are you?”",
