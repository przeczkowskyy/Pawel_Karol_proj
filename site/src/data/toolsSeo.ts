...
import { getTools, type ToolItem } from "./tools";
      ...
      "faq": [
        {
          ...
          "a": "Narzędzie wczytuje surowe eksporty (godziny, materiał, koszty) w przeglądarce, pokazuje podgląd i liczy diff wobec poprzedniej wersji, więc widzisz każdą zmianę. Potem uzgadnia sumy co do grosza i zwraca jednoznaczny wynik PASS/FAIL; dopiero wtedy zatwierdzasz nową wersję."
        },
        {
      ...
      "faq": [
        {
          ...
          "a": "The tool parses raw exports (hours, material, costs) in the browser, shows a preview and computes a diff against the previous version, so you see every change. It then reconciles the totals to the cent and returns a clear PASS/FAIL; only then do you approve the new version."
        },
        {
    ...
    "pl": {
      ...
      "faq": [
        ...
        },
        {
          ...
          "a": "Nie. Narzędzia Klarow działają lokalnie, on-premise, więc harmonogram zostaje w firmie. Demo na tej stronie liczy w całości w przeglądarce: bez serwera, bez wysyłki plików i bez wywołań zewnętrznych API."
        },
        {
          "q": "Jak wygląda wdrożenie u nas i ile trwa pilot?",
    ...
    "en": {
      ...
      "faq": [
        ...
        },
        {
          ...
          "a": "No. Klarow tools run locally, on-premise, so the schedule stays inside your company. The demo on this page computes entirely in your browser: no server, no file upload, no calls to external APIs."
        },
        {
    ...
    "pl": {
      ...
      "faq": [
        ...
        },
        {
          ...
          "a": "Nie. Narzędzia Klarow działają lokalnie, on-premise, więc wnioski, decyzje i plan płatności zostają na Waszych maszynach. Demo na tej stronie liczy w 100% w przeglądarce: nie ma serwera, więc nie ma dokąd wysłać danych."
        },
        {
    ...
    "en": {
      ...
      "faq": [
        ...
        },
        {
          ...
          "a": "No. Klarow tools run locally, on-premise, so requests, decisions and the payment plan stay on your machines. The demo on this page computes 100% in the browser: there is no server, so there is nowhere for the data to go."
        },
        {
    ...
    "pl": {
      ...
      "faq": [
        ...
        },
        {
          ...
          "a": "Nie. Narzędzia Klarow działają lokalnie (on-premise), na infrastrukturze firmy, więc dane kosztowe nie opuszczają organizacji, a wszystkie zmiany są zapisywane lokalnie, bez serwera w chmurze. Demo na tej stronie liczy w 100% w przeglądarce, więc możesz je sprawdzić bez wysyłania czegokolwiek."
        },
        {
      ...
      "faq": [
        {
          ...
          "a": "Klarow's Project cost controlling tool takes project data (budget, cost to date and estimates) and turns it into a project manager's view: budget / spend / overrun bars per stage. The estimates-to-complete (ETC) are editable, and the estimate-at-completion (EAC) and margin forecast recompute live. It is deterministic, a calculator rather than a crystal ball: the same input always gives the same result."
        },
        {
          "q": "Does our cost data go to the cloud?",
          "a": "No. Klarow tools run on-premise, on your own infrastructure, so cost data never leaves your company, and all changes are saved locally, with no cloud server involved. The demo on this page computes 100% in the browser, so you can try it without sending anything anywhere."
        },
        {
    ...
    "pl": {
      ...
      "faq": [
        ...
        },
        {
          ...
          "a": "Zaczynamy od pilota na kopii plików: jeden proces, stała cena, płatność 50/50 i do 10 dni roboczych, z pierwszym efektem zwykle w dniu 5. Konfigurujemy słownik pod Twoje kategorie kosztów i strukturę plików, a Ty sprawdzasz każdy przebieg w trybie TEST, zanim cokolwiek zostanie zapisane. Budujemy dla firm 20–250 osób, które wyrosły na Excelu."
        },
        {
      ...
      "faq": [
        {
          ...
          "a": "Narzędzie czyta rejestry godzin i generuje z nich miesięczne protokoły kosztu pracy per podwykonawca, czyli gotowe dokumenty PDF. Kreator prowadzi każdy protokół przez cykl DRAFT → akceptacja → faktura, z jawnym statusem na każdym kroku. Wynik jest deterministyczny: te same rejestry dają zawsze identyczny protokół."
        },
        {
          "q": "Czy godziny i stawki podwykonawców wychodzą poza firmę, np. do chmury?",
          "a": "Nie. Narzędzia Klarow działają lokalnie, na komputerach w Waszej firmie, więc rejestry godzin, stawki i protokoły nie opuszczają firmowej infrastruktury. Demo na tej stronie liczy w 100% w przeglądarce: zero serwera i zero wysyłki danych."
        },
        {
    ...
    "en": {
      ...
      "faq": [
        ...
        },
        {
          ...
          "a": "No. Klarow tools run on-premise, on your company's own machines, so hour registers, rates and protocols never leave your infrastructure. The demo on this page computes 100% in the browser: no server, no data upload."
        },
        {
      ...
      "faq": [
        {
          ...
          "a": "Umowy dodajesz formularzem albo wczytujesz istniejący plik Excel i ZIP ze skanami, a narzędzie buduje z nich rejestr z drzewem skanów PDF i cyklem życia każdej umowy. W drugą stronę eksportuje arkusz z linkami względnymi, więc Excel pozostaje źródłem prawdy i rejestr działa dalej po przeniesieniu katalogu."
        },
        {
          "q": "Czy dane umów albo skany trafiają do chmury?",
          "a": "Nie. Narzędzia Klarow działają lokalnie, na sprzęcie firmy, więc umowy i skany nie opuszczają Twojej infrastruktury. Demo na tej stronie liczy w 100% w Twojej przeglądarce: bez serwera i bez wysyłania danych."
        },
        {
      ...
      "faq": [
        {
          ...
          "a": "You add contracts through a form or load an existing Excel file plus a ZIP of scans, and the tool builds a register with a PDF scan tree and a lifecycle for each contract. It exports back to a spreadsheet with relative links, so Excel stays the source of truth and the register survives moving the folder."
        },
        {
          "q": "Does any contract data or scan end up in the cloud?",
          "a": "No. Klarow tools run locally, on your own hardware, so contracts and scans never leave your infrastructure. The demo on this page runs 100% in your browser: no server, no data upload."
        },
        {
  ...
  "kontroling-ksef": {
    "pl": {
      "seo": {
        ...
        "description": "Read-only integracja z API KSeF (Ministerstwo Finansów): faktury sprzedaży i zakupu, budżet vs wykonanie, prognoza cashflow 13 tyg., raporty XLSX. Dane u Ciebie."
      },
      "faq": [
        {
        ...
        },
        {
          ...
          "a": "Nie. Connector jest wyłącznie odczytowy: nie wysyła żadnych faktur do KSeF, tylko pobiera i liczy. Całość działa on-premise, na Twoim serwerze (Flask + SQLite), a oryginalny XML faktur zostaje lokalnie do celów audytu. Poza Twój serwer nie wychodzi ani jedna faktura."
        },
        {
    ...
    "en": {
      "seo": {
        ...
        "description": "Read-only integration with the KSeF API (Ministry of Finance): sales and purchase invoices, budget vs actual, 13-week cash-flow forecast, XLSX reports. On-premise."
      },
      "faq": [
        {
        ...
        },
        {
          ...
          "a": "No. The connector is strictly read-only: it never sends invoices to KSeF, it only pulls and computes. Everything runs on-premise on your own server (Flask + SQLite), and the original invoice XML stays local for audit. Not a single invoice ever leaves your server."
        },
        {
        ...
        },
        {
          ...
          "a": "We build it around your chart of accounts and processes: invoice categorization (by tax ID and keywords), project definitions and the budget are all configured for you. It is a real deployment, not an in-browser demo, because it needs a connection to the KSeF API and your server. We start with a diagnosis and set the scope and price for your company."
        }
      ]
    }
  }
...
/* Katalog wzbogacony o long-tail meta i FAQ. Importuj TYLKO tam, gdzie te dane
   naprawdę są renderowane: podstrona narzędzia (chunk lazy) i prerender.
   Import w pliku ładowanym na stronie głównej wrzuci cały ten słownik do chunku
   krytycznego i wywali budżet 140 KB gz (reguła perf-js-budget-home). */
export function getToolsWithSeo(lang: Lang): ToolItem[] {
  return getTools(lang).map((t) => {
    const extra = TOOLS_SEO[t.slug]?.[lang];
    /* brak wpisu = strona działa jak dotąd, na fallbackach z ToolPage */
    return extra ? { ...t, seo: extra.seo, faq: extra.faq } : t;
  });
}

export const findToolWithSeo = (slug: string, lang: Lang): ToolItem | undefined =>
  getToolsWithSeo(lang).find((t) => t.slug === slug);
