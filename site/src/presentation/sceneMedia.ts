...
/* ── Materiał do podmiany, gdy Higgsfield będzie opłacony ──────────────────
   ...
   const S = (name: string): SceneVideoAsset => ({
     ...
     poster: `/media/presentation/${name}-v4.webp`,
   });
...
export const SCENE_MEDIA: Record<SceneId, SceneMediaEntry> = {
  ...
  hook: {
    id: "hook",
    still: "/media/presentation/scene-hook-v4.webp",
    fallback: "shot",
  },
  ...
  handover: {
    id: "handover",
    still: "/media/presentation/scene-handover-v4.webp",
    fallback: "shot",
  },
  ...
  time: {
    id: "time",
    still: "/media/presentation/scene-time-v4.webp",
    fallback: "shot",
  },
  ...
  cost: {
    id: "cost",
    still: "/media/presentation/scene-cost-v4.webp",
    fallback: "shot",
  },
  ...
  turn: {
    id: "turn",
    still: "/media/presentation/scene-turn-v4.webp",
    fallback: "shot",
  },
  ...
  craft: {
    id: "craft",
    still: "/media/presentation/scene-craft-v4.webp",
    fallback: "shot",
  },
  ...
  outcome: {
    id: "outcome",
    still: "/media/presentation/scene-outcome-v4.webp",
    fallback: "shot",
  },
  ...
  contact: {
    id: "contact",
    still: "/media/presentation/scene-contact-v4.webp",
    fallback: "shot",
  },
};
